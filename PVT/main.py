...
num_class = 100
batch_size = 8
data_dir = '/Users/wangjing/Desktop/PVT/cifar100/'
param_dir = '/Users/wangjing/Desktop/PVT/pvt_tiny_cifar.pt'
figure_dir = '/Users/wangjing/Desktop/PVT/pvt_'
num_epochs_train = 12
#milestone = [100,200]
lr = 5e-04
pretrain = False
...
train_iter = torch.utils.data.DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=0, pin_memory=True, drop_last=True)
test_iter = torch.utils.data.DataLoader(test_dataset, batch_size=batch_size, shuffle=True, num_workers=0, pin_memory=True)
